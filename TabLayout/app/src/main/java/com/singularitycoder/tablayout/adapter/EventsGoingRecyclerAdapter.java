...
public class EventsGoingRecyclerAdapter extends RecyclerView.Adapter<EventsGoingRecyclerAdapter.EventViewHolder> implements Filterable {
    ...
    public EventsGoingRecyclerAdapter(ArrayList<EventItemModel> eventsList, Context context) {
    ...
    public EventViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_recycler_going_events, viewGroup, false);
...
//        ImageView imgMoreEventOptions;
        ...
        public EventViewHolder(View itemView) {
            ...
            btnEventShare = itemView.findViewById(R.id.img_event_share);
