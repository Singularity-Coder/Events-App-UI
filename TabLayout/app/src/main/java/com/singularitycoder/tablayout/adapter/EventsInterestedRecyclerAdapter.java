...
public class EventsInterestedRecyclerAdapter extends RecyclerView.Adapter<EventsInterestedRecyclerAdapter.EventViewHolder> implements Filterable {
    ...
    public EventsInterestedRecyclerAdapter(ArrayList<EventItemModel> eventsList, Context context) {
    ...
    public EventViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_recycler_interested_events, viewGroup, false);
    ...
    public void onBindViewHolder(final EventViewHolder eventViewHolder, int i) {
        ...
        eventViewHolder.btnEventGoing.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (eventViewHolder.btnEventGoing.getText().toString().equals("Going")) {
                    eventViewHolder.btnEventGoing.setText("✓ Going");
                    eventViewHolder.btnEventGoing.setTextSize(15);

                    Drawable buttonDrawable = eventViewHolder.btnEventGoing.getBackground();
                    buttonDrawable = DrawableCompat.wrap(buttonDrawable);
                    DrawableCompat.setTint(buttonDrawable, context.getResources().getColor(R.color.colorGreen));
                    eventViewHolder.btnEventGoing.setBackground(buttonDrawable);
                    eventViewHolder.btnEventGoing.setTextColor(context.getResources().getColor(R.color.colorWhite));
                    eventViewHolder.btnEventGoing.setEnabled(false);
...
//                    Drawable buttonDrawable = eventViewHolder.btnEventGoing.getBackground();
//                    buttonDrawable = DrawableCompat.wrap(buttonDrawable);
//                    DrawableCompat.setTint(buttonDrawable, context.getResources().getColor(R.color.colorWhite));
//                    eventViewHolder.btnEventGoing.setBackground(buttonDrawable);
//                    eventViewHolder.btnEventGoing.setTextColor(context.getResources().getColor(R.color.colorSkyBlue));
//
////                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
...
//        builder.setTitle("More Event Options");
    ...
    class EventViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public EventViewHolder(View itemView) {
            ...
            btnEventGoing = itemView.findViewById(R.id.btn_event_going);
